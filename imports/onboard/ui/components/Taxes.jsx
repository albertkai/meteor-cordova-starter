...
import { MoneyIcon } from '/imports/onboard';
  ...
  render() {
    return (
      <div id="taxes">
        ...
        <p>В конце каждого календарного месяца, мы берем всю накопленную сумму штрафов (за вычетом расходов компании), и перечисляем их на благотворительность</p>
